...
### Table 1.1 Number of Conservation Reserves
```{r, include = TRUE, echo=FALSE}
...
df2 %>%
  ...
  kable(format = "latex", booktabs = T, caption = NULL,
         col.names = c('Region', 'Total Population', 'White (%)', 'Black (%)', 'Other Race (%)', 'Latinx (%)', 'People of Color (%)', 'Median Income ($US)')) %>%
